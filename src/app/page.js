...
const INITIAL_IMAGES = [
  {
    id: 1,
    src: "/image.png",
    alt: "Sacred Vows — Wedding Cinematography",
    title: "Sacred Vows",
    category: "Wedding Cinematography",
    year: "2026",
    location: "Jaipur, Rajasthan, India",
    metadata: "Sony FX3 • 24-70mm GM II • DJI RS4",
    description: "An intimate destination wedding film capturing rituals, emotions, and timeless family moments with a cinematic storytelling approach.",
    aspect: "aspect-[3/4]",
  ...
  },
  {
    id: 2,
    src: "/image copy.png",
    alt: "Before Forever — Pre-Wedding",
...
{/* HARSHIT IMAGES */}
{/* HARSHIT IMAGES */}
<div className="relative hidden lg:block w-[420px] h-[420px] flex-shrink-0 z-10 ml-0 mb-29 mr-44">
  {[
    {
      src: "/harshit1.png",
      // Top image
      position: "absolute top-0 left-0 z-30 rotate-[-8deg]",
    },
    {
      src: "/harshit2.png",
      // Center image (main image)
      position: "absolute top-30 left-20 z-20 rotate-[2deg]",
    },
    {
      src: "/harshit3.png",
      // Bottom image
      position: "absolute top-66 left-32 z-10 rotate-[8deg]",
    },
  ].map((item, i) => (
    <div
      key={i}
      className={`group ${item.position} transition-all duration-500 hover:-translate-y-3 hover:scale-105 hover:z-50`}
    >
      <div className="bg-[#090d1a]/95 border border-zinc-800/80 p-3 md:p-4 shadow-2xl rounded-sm backdrop-blur-sm transition-colors duration-300 group-hover:border-brand-accent/30 group-hover:bg-[#0d1527]">
        
        {/* Image */}
        <div className="relative overflow-hidden rounded-sm border border-zinc-900 bg-zinc-950">
          <img
            src={item.src}
            alt={`Harshit ${i + 1}`}
            className="w-[180px] h-[230px] object-cover select-none pointer-events-none transition-transform duration-700 ease-out group-hover:scale-105"
            loading="lazy"
          />
  ...
  {/* Decorative Glow */}
  <div className="absolute top-20 right-0 w-48 h-48 bg-brand-accent/10 blur-3xl rounded-full pointer-events-none" />
</div>
        </section>
              ...
              <div className="lg:col-span-5 p-6 md:p-8 flex flex-col justify-between bg-[#090d1a] border-t lg:border-t-0 lg:border-l border-zinc-900">
                ...
                <div className="pt-6 border-t border-zinc-900 flex justify-between items-center gap-4 mt-6">
                  <button
                    ...
                    className={`flex-grow py-3 px-6 text-xs uppercase tracking-widest font-semibold border rounded-sm flex items-center justify-center space-x-2 transition-all duration-200 ${
