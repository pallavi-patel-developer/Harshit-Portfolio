...
const INITIAL_IMAGES = [
  ...
  {
    id: 6,
    src: "/Harry VIRAL VERY VIRAL AD.mp4",
    alt: "Faces & Stories",
    title: "Faces & Stories",
    category: "Portrait Cinematography",
    year: "2026",
  ...
  return (
    <div id="top" className="min-h-screen relative flex flex-col justify-between selection:bg-brand-accent selection:text-white">
      ...
      <footer className="w-full py-12 px-6 md:px-12 border-t border-zinc-900 bg-black/40 text-xs text-zinc-500 flex flex-col md:flex-row justify-between items-center gap-6">
        ...
        <div className="flex items-center space-x-2">
          <a href="https://www.instagram.com/_starboy_harshit_?igsh=cmU0cW5uNWRoZDM=" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors duration-200 flex items-center space-x-1 group">
            <svg className="w-4.5 h-4.8 text-zinc-500 group-hover:text-brand-accent transition-colors" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="20" height="20" x="2" y="2" rx="5" ry="5" /><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z" /><line x1="17.5" x2="17.51" y1="6.5" y2="6.5" /></svg>
            <span className="hidden sm:inline text-[12px] uppercase tracking-widest text-zinc-500 group-hover:text-white transition-colors">_starboy_harshit_</span>
          </a>
